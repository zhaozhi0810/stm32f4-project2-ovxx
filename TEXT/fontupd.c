...
u8 updata_fontx(u16 x,u16 y,u8 size,u8 *fxpath,u8 fx)
{
	...
	u32 offx=0;
	u8 rval=0;	     
	fftemp=(FIL*)mymalloc(SRAMEX,sizeof(FIL));	//分配内存	SRAMIN
	if(fftemp==NULL)rval=1;
	tempbuf=mymalloc(SRAMEX,4096);				//分配4096个字节空间SRAMIN
